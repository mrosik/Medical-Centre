...
class HoursControllerTest < ActionController::TestCase
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post :create, hour: { appointment_date: @hour.appointment_date, appointment_time: @hour.appointment_time }
    end
  ...
  test "should update hour" do
    put :update, id: @hour, hour: { appointment_date: @hour.appointment_date, appointment_time: @hour.appointment_time }
    assert_redirected_to hour_path(assigns(:hour))
  end
